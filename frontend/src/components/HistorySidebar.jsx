...
const HistorySidebar = ({ 
  ...
  return (
    <div className="fixed inset-0 z-50 flex justify-end overflow-hidden">
      ...
      {/* Sidebar Panel */}
      <div className="relative w-full sm:w-[400px] h-full flex flex-col bg-white/90 dark:bg-slate-900/90 backdrop-blur-md border-l border-slate-200/50 dark:border-slate-800/50 text-slate-900 dark:text-slate-100 shadow-2xl animate-slide-in">
